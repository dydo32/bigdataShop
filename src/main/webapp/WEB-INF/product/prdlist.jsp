			...
			<ul>
				...
				<li class="typeGallery"><a href="#"
					onclick="dataViewType( 2 );return false;"> <img
						src="/bigdataShop/resources/images/icn_gllry_2.gif" alt="갤러리 형" />
				</a></li>
		...
		<div class="boardAreaList">
			...
			<ul class="goodsAreaG">
				...
				<c:forEach var="prd" items="${prdlist }">
						<li><a href="/bigdataShop/product/read.do?category_no=${prd.category_no }&prd_no=${prd.prd_no}" class="goodsLink" 
